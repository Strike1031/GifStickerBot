...
IMAGE_STICKER_MESSAGE = "Please send image sticker\n\It can accept images of most file formats and existing image stickers"

VIDEO_STICKER_MESSAGE = "Please send video sticker\n\It can accept videos of most file formats, existing video stickers and telegram video notes"
...
INVALID_PACK_MESSAGE = "Sticker pack selected must be created by this bot."
